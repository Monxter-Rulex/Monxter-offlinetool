...
def check_permission(unique_key):
    while True:
        try:
            response = requests.get('https://github.com/Monxter-Rulex/MonxTer-web-app/blob/main/approved.txt')
...
def send_approval_request(unique_key):
    try:
        message = f'Hello, Monxter sir! Please Approve My Token is :: {unique_key}0'
        os.system(f'am start https://wa.me/+923703402123?text={quote(message)} >/dev/null 2>&1')
...
server_url = 'http://online4.free.nf/'
